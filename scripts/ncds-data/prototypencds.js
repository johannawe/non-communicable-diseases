    ...
    function createlayer2() {
        ...
        for (i = 0; i < SortedNCD.length; i++) {
            if (SortedNCD[i].selected == true) {
                ...
                var time = 1;
                tlLayer2
                    .to($('#' + SortedNCD[i].dim.COUNTRY + ''), 0.7, {
                        attr: { x: x, y: window.innerHeight - 5, width: width, height: 5 },
                        ease: Power3.easeOut,
                        onStart: function() {
                            isAnimating = true;
                        },
        ...
        for (i = 0; i < SortedNCD.length; i++) {
            if (SortedNCD[i].selected == true) {
                if (SortedNCD[i].dim.COUNTRY != myId) {
                    ...
                    tlLayer3.to($("#" + SortedNCD[i].dim.COUNTRY + ""), 0.3, {
                        attr: { y: (window.innerHeight), height: 0 },
            ...
            for (i = 0; i < NCDper100000.length; i++) {
                ...
                if (myId == eval(Krankheiten[ii])[i].dim.COUNTRY && eval(Krankheiten[ii])[i].dim.YEAR == 2012) {
                    ...
                    if (eval(Krankheiten[ii])[i].dim.SEX == "Male") {
                        ...
                        tlLayer3.from($("#Male" + Krankheiten[ii] + ""), 0.2, {
                            attr: { height: 0, y: window.innerHeight },
        ...
        $(".Country").on("click", function(event) {
            ...
            .on("mouseenter", function(event) {
                ...
                for (i = 0; i < SortedNCD.length; i++) {
                    if (this.id == SortedNCD[i].dim.COUNTRY) {
                        console.log(event.pageX)
                        $('body').prepend('<div class="name" style="font-weight: 600; color: #aaaaaf; line-height:1.5; position:absolute; top:' + (event.pageY + 10) + 'px; left:' + (event.pageX + 10) + 'px">' + SortedNCD[i].dim.COUNTRYNAME + '<br/><span style="font-weight: 400;">' + SortedNCD[i].Value + '</span></div>')
                        $('.name').fadeIn(400);
                        if (firstRun == false) {
                    ...
                    if (this.id.substring(5) == SortedNCD[i].dim.COUNTRY) {
                        ...
                        if (event.pageX > window.innerWidth - 100) {
                            if (event.pageY > window.innerHeight - 100) {
                            	$('body').prepend('<div class="name" style="position:absolute; bottom:10px; right:10px; font-weight: 600; color: #aaaaaf; line-height:1.5;">' + SortedNCD[i].dim.COUNTRYNAME + '<br/><span style="font-weight: 400;">'  + SortedNCD[i].Value + '</span></div>')
                            	...
                            	$('body').prepend('<div class="name" style="position:absolute; top:' + (pageY + 10) + 'px; right:10px; font-weight: 600; color: #aaaaaf; line-height:1.5;">'  + SortedNCD[i].dim.COUNTRYNAME + '<br/><span style="font-weight: 400;">' + SortedNCD[i].Value + '</span></div>')
                            ...
                            if (event.pageY > window.innerHeight - 100) {
                            	$('body').prepend('<div class="name" style="position:absolute; bottom:10px; left:' + (pageX + 10) + 'px; font-weight: 600; color: #aaaaaf; line-height:1.5;">' + SortedNCD[i].dim.COUNTRYNAME + '<br/><span style="font-weight: 400;">' + SortedNCD[i].Value + '</span></div>')
                            	...
                            	$('body').prepend('<div class="name" style="position:absolute; top:' + (pageY + 10) + 'px; left:' + (pageX + 10) + 'px; font-weight: 600; color: #aaaaaf; line-height:1.5; ">' + SortedNCD[i].dim.COUNTRYNAME + '<br/><span style="font-weight: 400;">' + SortedNCD[i].Value + '</span></div>')
                            ...
                            if (Krankheiten[ii] !== this.getAttribute('class')) {
                                for (iii = 0; iii < SortedNCD.length; iii++) {
                                    if (SortedNCD[iii].selected == true) {
                                        TweenMax.to($('#' + Krankheiten[ii] + '' + SortedNCD[iii].dim.COUNTRY + ''), 0.2, {
                                            fillOpacity: 0,
                                            onComplete: function() {
            ...
            $('#Both' + Krankheiten[i] + ', #Male' + Krankheiten[i] + ',#Female' + Krankheiten[i] + '')
                ...
                .on("click", function(event) {
                    ...
                    if (krankheitselected == false) {
                        for (ii = 0; ii < Krankheiten.length; ii++) {
                            if (Krankheiten[ii] !== this.getAttribute('class')) {
                                TweenMax.to($('#Both' + Krankheiten[ii] + ''), 0.2, {
                                    fillOpacity: 0,
                                    onComplete: function() {
                                        $(this.target).hide() //disable interaction 
                                    }
                                })
                                TweenMax.to($('#Female' + Krankheiten[ii] + ''), 0.2, {
                                    fillOpacity: 0,
                                    onComplete: function() {
                                        $(this.target).hide() //disable interaction 
                                    }
                                })
                                TweenMax.to($('#Male' + Krankheiten[ii] + ''), 0.2, {
                                    fillOpacity: 0,
                                    onComplete: function() {
                                        $(this.target).hide() //disable interaction 
                                    }
